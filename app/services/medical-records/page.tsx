    ...
    <div className={`${isDarkMode ? 'bg-background text-foreground' : 'bg-background text-foreground'} overflow-x-hidden min-h-screen`}>
      ...
      <section className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-40">
        <div className="text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
            Secure, comprehensive electronic health records that ensure continuity of care, regulatory compliance, and seamless information sharing across your healthcare network.
          </p>
      ...
      <section className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            Comprehensive <span className="bg-gradient-to-r from-orange-600 to-orange-700 bg-clip-text text-transparent">EHR Solutions</span>
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Advanced electronic health records that adapt to your workflow while ensuring compliance and data security.
          </p>
        </div>
          ...
          {[
            {
              ...
              desc: 'Comprehensive patient records with structured data entry, templates, and voice-to-text capabilities.'
            },
            {
              icon: Search,
              title: 'Advanced Search',
              desc: 'Powerful search functionality to quickly find patient information, lab results, and medical history.'
            },
            {
              icon: Archive,
              title: 'Secure Storage',
              desc: 'HIPAA-compliant cloud storage with automatic backups, encryption, and disaster recovery.'
            },
            {
              icon: Users,
              title: 'Multi-Provider Access',
              desc: 'Controlled access for multiple healthcare providers with role-based permissions and audit trails.'
            },
            {
              icon: BarChart3,
              title: 'Clinical Analytics',
              desc: 'Built-in analytics for population health management and clinical decision support.'
            },
            {
              icon: Shield,
              title: 'Regulatory Compliance',
              desc: 'Full compliance with HIPAA, HITECH, and other healthcare regulations with automated reporting.'
            }
          ].map((feature, i) => {
      ...
      <section className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className={`${isDarkMode ? 'bg-gradient-to-r from-orange-500/10 via-orange-500/5 to-orange-500/10' : 'bg-gradient-to-r from-orange-500/10 via-orange-500/5 to-orange-500/10'} rounded-3xl p-12 text-center`}>
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            Ready to Modernize Your <span className="bg-gradient-to-r from-orange-600 to-orange-700 bg-clip-text text-transparent">Medical Records</span>?
          </h2>
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Join healthcare organizations that have improved patient care and operational efficiency with MediTrack+ EHR.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/auth/signup">
              <Button className={`bg-gradient-to-r ${colorClasses.primary} ${colorClasses.primaryHover} text-lg px-8 py-4`}>
