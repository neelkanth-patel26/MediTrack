...
import {
  ...
  Search, Archive, AlertTriangle, TrendingUp, PieChart
} from 'lucide-react'
    ...
    <div className={`${isDarkMode ? 'bg-background text-foreground' : 'bg-background text-foreground'} overflow-x-hidden min-h-screen`}>
      ...
      <section className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-40">
        <div className="text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold leading-tight mb-6">
            Data-Driven <span className="block bg-gradient-to-r from-orange-600 to-orange-700 bg-clip-text text-transparent">
              Healthcare Insights
            </span>
          </h1>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
            Transform healthcare data into actionable insights with advanced analytics, predictive modeling, and comprehensive reporting tools.
          </p>
      ...
      <section className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            Advanced <span className="bg-gradient-to-r from-orange-600 to-orange-700 bg-clip-text text-transparent">Analytics Platform</span>
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Comprehensive analytics tools that turn healthcare data into meaningful insights for better patient care and operational efficiency.
          </p>
        </div>
          ...
          {[
            {
              ...
              desc: 'Track key performance indicators, patient outcomes, and practice efficiency with real-time dashboards.'
            },
            {
              icon: PieChart,
              title: 'Population Health',
              desc: 'Analyze population health trends, risk stratification, and preventive care opportunities across patient groups.'
            },
            {
              icon: BarChart3,
              title: 'Clinical Outcomes',
              desc: 'Monitor treatment effectiveness, patient satisfaction, and quality of care metrics with detailed reporting.'
            },
            {
              icon: Activity,
              title: 'Predictive Analytics',
              desc: 'AI-powered predictions for patient readmissions, disease progression, and resource utilization planning.'
            },
            {
              icon: Database,
              title: 'Data Integration',
              desc: 'Seamlessly integrate data from multiple sources including EHRs, labs, imaging, and wearable devices.'
            },
            {
              icon: Shield,
              title: 'Privacy & Security',
              desc: 'HIPAA-compliant analytics with de-identified data processing and secure, encrypted reporting.'
            }
          ].map((feature, i) => {
      ...
      <section className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className={`${isDarkMode ? 'bg-gradient-to-r from-orange-500/10 via-orange-500/5 to-orange-500/10' : 'bg-gradient-to-r from-orange-500/10 via-orange-500/5 to-orange-500/10'} rounded-3xl p-12 text-center`}>
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            Ready to Unlock the Power of <span className="bg-gradient-to-r from-orange-600 to-orange-700 bg-clip-text text-transparent">Health Data</span>?
          </h2>
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Join healthcare organizations that use data-driven insights to improve patient care and operational excellence.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/auth/signup">
              <Button className={`bg-gradient-to-r ${colorClasses.primary} ${colorClasses.primaryHover} text-lg px-8 py-4`}>
