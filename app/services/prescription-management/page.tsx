    ...
    <div className={`${isDarkMode ? 'bg-background text-foreground' : 'bg-background text-foreground'} overflow-x-hidden min-h-screen`}>
      ...
      <section className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-40">
        <div className="text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
            Streamline prescription workflows, ensure medication safety, and improve patient outcomes with our comprehensive prescription management system.
          </p>
      ...
      <section className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            Complete <span className="bg-gradient-to-r from-orange-600 to-orange-700 bg-clip-text text-transparent">Prescription Solutions</span>
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Advanced prescription management tools that ensure safety, compliance, and efficiency in medication dispensing.
          </p>
        </div>
          ...
          {[
            {
              ...
              desc: 'Secure e-prescribing with integration to pharmacies, automatic formulary checking, and real-time eligibility verification.'
            },
            {
              icon: AlertTriangle,
              title: 'Drug Interaction Alerts',
              desc: 'Advanced drug interaction checking, allergy alerts, and contraindication warnings to prevent medication errors.'
            },
            {
              icon: Search,
              title: 'Medication History',
              desc: 'Complete medication history tracking across all providers and pharmacies for comprehensive patient care.'
            },
            {
              icon: Clock,
              title: 'Refill Management',
              desc: 'Automated refill requests, authorization tracking, and patient reminders for medication adherence.'
            },
            {
              icon: BarChart3,
              title: 'Usage Analytics',
              desc: 'Detailed analytics on prescribing patterns, medication effectiveness, and practice performance metrics.'
            },
            {
              icon: Shield,
              title: 'Controlled Substances',
              desc: 'DEA-compliant management of controlled substances with secure storage and comprehensive audit trails.'
            }
          ].map((feature, i) => {
      ...
      <section className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className={`${isDarkMode ? 'bg-gradient-to-r from-orange-500/10 via-orange-500/5 to-orange-500/10' : 'bg-gradient-to-r from-orange-500/10 via-orange-500/5 to-orange-500/10'} rounded-3xl p-12 text-center`}>
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            Ready to Optimize Your <span className="bg-gradient-to-r from-orange-600 to-orange-700 bg-clip-text text-transparent">Prescription Workflow</span>?
          </h2>
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Join healthcare providers who have improved medication safety and patient outcomes with MediTrack+ prescription management.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/auth/signup">
              <Button className={`bg-gradient-to-r ${colorClasses.primary} ${colorClasses.primaryHover} text-lg px-8 py-4`}>
