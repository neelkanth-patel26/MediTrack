...
import {
  ...
  Settings, AlertCircle, Globe, Briefcase, Microscope
} from 'lucide-react'
    ...
    <div className={`${isDarkMode ? 'bg-background text-foreground' : 'bg-background text-foreground'} overflow-x-hidden min-h-screen`}>
      ...
      <section className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-40">
        <div className="text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold leading-tight mb-6">
            Your Complete <span className="block bg-gradient-to-r from-orange-600 to-orange-700 bg-clip-text text-transparent">
              Medical Workspace
            </span>
          </h1>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
            Access patient records, manage appointments, collaborate with colleagues, and streamline your medical practice with our comprehensive doctor portal.
          </p>
      ...
      <section className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            Everything You Need in One <span className="bg-gradient-to-r from-orange-600 to-orange-700 bg-clip-text text-transparent">Professional Portal</span>
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            A comprehensive workspace designed specifically for healthcare professionals to manage their practice efficiently.
          </p>
        </div>
          ...
          {[
            {
              ...
              desc: 'Quick access to patient information, medical history, and treatment plans with intuitive navigation.'
            },
            {
              icon: Calendar,
              title: 'Schedule Management',
              desc: 'Manage appointments, view availability, and coordinate with other healthcare providers seamlessly.'
            },
            {
              icon: FileText,
              title: 'Electronic Health Records',
              desc: 'Comprehensive EHR system with secure access to patient records, lab results, and medical imaging.'
            },
            {
              icon: MessageSquare,
              title: 'Secure Communication',
              desc: 'HIPAA-compliant messaging with patients, colleagues, and other healthcare providers.'
            },
            {
              icon: Microscope,
              title: 'Diagnostic Tools',
              desc: 'AI-powered diagnostic assistance and integration with laboratory and imaging systems.'
            },
            {
              icon: BarChart3,
              title: 'Practice Analytics',
              desc: 'Track patient outcomes, practice performance, and generate insights for better care delivery.'
            }
          ].map((feature, i) => {
      ...
      <section className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className={`${isDarkMode ? 'bg-gradient-to-r from-orange-500/10 via-orange-500/5 to-orange-500/10' : 'bg-gradient-to-r from-orange-500/10 via-orange-500/5 to-orange-500/10'} rounded-3xl p-12 text-center`}>
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            Ready to Transform Your <span className="bg-gradient-to-r from-orange-600 to-orange-700 bg-clip-text text-transparent">Medical Practice</span>?
          </h2>
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Join thousands of healthcare professionals who trust MediTrack+ for their daily practice management.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/auth/signup">
              <Button className={`bg-gradient-to-r ${colorClasses.primary} ${colorClasses.primaryHover} text-lg px-8 py-4`}>
