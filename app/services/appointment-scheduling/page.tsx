    ...
    <div className={`${isDarkMode ? 'bg-background text-foreground' : 'bg-background text-foreground'} overflow-x-hidden min-h-screen`}>
      ...
      <section className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-40">
        <div className="text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
            Eliminate scheduling conflicts, reduce no-shows, and optimize your practice's time with our intelligent appointment scheduling system.
          </p>
      ...
      <section className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            Revolutionize Your <span className="bg-gradient-to-r from-orange-600 to-orange-700 bg-clip-text text-transparent">Appointment Management</span>
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Advanced scheduling features that adapt to your practice's unique needs and maximize efficiency.
          </p>
        </div>
          ...
          {[
            {
              ...
              desc: 'AI-powered scheduling that considers provider availability, patient preferences, and room resources.'
            },
            {
              icon: Clock,
              title: 'Automated Reminders',
              desc: 'Multi-channel reminders via email, SMS, and app notifications to reduce no-shows by up to 50%.'
            },
            {
              icon: Smartphone,
              title: 'Online Booking',
              desc: 'Patient portal for self-scheduling with real-time availability and instant confirmation.'
            },
            {
              icon: Users,
              title: 'Waitlist Management',
              desc: 'Automatic waitlist management with intelligent notifications when appointments become available.'
            },
            {
              icon: BarChart3,
              title: 'Analytics & Insights',
              desc: 'Detailed analytics on scheduling patterns, utilization rates, and optimization opportunities.'
            },
            {
              icon: Shield,
              title: 'Secure & Compliant',
              desc: 'HIPAA-compliant scheduling with encrypted data and comprehensive audit trails.'
            }
          ].map((feature, i) => {
      ...
      <section className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className={`${isDarkMode ? 'bg-gradient-to-r from-orange-500/10 via-orange-500/5 to-orange-500/10' : 'bg-gradient-to-r from-orange-500/10 via-orange-500/5 to-orange-500/10'} rounded-3xl p-12 text-center`}>
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            Ready to Optimize Your <span className="bg-gradient-to-r from-orange-600 to-orange-700 bg-clip-text text-transparent">Scheduling Process</span>?
          </h2>
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Join healthcare practices that have reduced administrative time and improved patient satisfaction with MediTrack+.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/auth/signup">
              <Button className={`bg-gradient-to-r ${colorClasses.primary} ${colorClasses.primaryHover} text-lg px-8 py-4`}>
