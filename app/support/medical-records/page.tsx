  ...
  const articles = [
    {
      ...
      desc: 'Learn how to securely upload and organize patient medical documents.',
      readTime: '6 min read',
      difficulty: 'Beginner'
    },
    {
      title: 'Organizing Patient Files',
      desc: 'Best practices for categorizing and structuring medical record folders.',
      readTime: '5 min read',
      difficulty: 'Beginner'
    },
    {
      title: 'Digital Document Scanning',
      desc: 'Convert paper documents to digital format with OCR technology.',
      readTime: '7 min read',
      difficulty: 'Intermediate'
    },
    {
      title: 'Record Access Permissions',
      desc: 'Control who can view and edit patient medical records in your practice.',
      readTime: '8 min read',
      difficulty: 'Intermediate'
    },
    {
      title: 'Medical History Templates',
      desc: 'Use standardized templates for consistent medical history documentation.',
      readTime: '6 min read',
      difficulty: 'Beginner'
    },
    {
      title: 'Lab Results Integration',
      desc: 'Import and organize laboratory test results from external providers.',
      readTime: '9 min read',
      difficulty: 'Intermediate'
    },
    {
      title: 'Imaging Records Management',
      desc: 'Store and manage X-rays, MRIs, and other medical imaging files.',
      readTime: '8 min read',
      difficulty: 'Intermediate'
    },
    {
      title: 'Record Version Control',
      desc: 'Track changes and maintain version history for medical documents.',
      readTime: '7 min read',
      difficulty: 'Advanced'
    },
    {
      title: 'Patient Portal Access',
      desc: 'Allow patients to view and download their own medical records.',
      readTime: '5 min read',
      difficulty: 'Beginner'
    },
    {
      title: 'Record Archiving Policies',
      desc: 'Set up automated archiving for old records while maintaining accessibility.',
      readTime: '10 min read',
      difficulty: 'Advanced'
    },
    {
      title: 'HIPAA Compliance for Records',
      desc: 'Ensure all medical records meet HIPAA privacy and security standards.',
      readTime: '12 min read',
      difficulty: 'Advanced'
    },
    {
      title: 'Bulk Record Import',
      desc: 'Import large volumes of existing medical records from other systems.',
      readTime: '11 min read',
      difficulty: 'Advanced'
    },
    {
      title: 'Record Search & Filtering',
      desc: 'Advanced search techniques to quickly find specific medical information.',
      readTime: '6 min read',
      difficulty: 'Intermediate'
    },
    {
      title: 'Emergency Record Access',
      desc: 'Procedures for urgent access to patient records in emergency situations.',
      readTime: '8 min read',
      difficulty: 'Intermediate'
    },
    {
      title: 'Record Backup & Recovery',
      desc: 'Automated backup systems and disaster recovery procedures for medical data.',
      readTime: '9 min read',
      difficulty: 'Advanced'
    }
  ]
      ...
      <section className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
        <div className="text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-extrabold leading-tight mb-6">
            Secure <span className="block bg-gradient-to-r from-orange-600 to-orange-700 bg-clip-text text-transparent">
              Record Management
            </span>
          </h1>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
            Upload, organize, and manage patient medical records securely. Learn HIPAA-compliant practices for digital healthcare documentation.
          </p>
      ...
      <section className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            Records <span className="bg-gradient-to-r from-orange-600 to-orange-700 bg-clip-text text-transparent">Management</span>
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Comprehensive guides for secure medical record handling and HIPAA compliance.
          </p>
        </div>
