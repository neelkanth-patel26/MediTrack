  ...
  const articles = [
    {
      ...
      desc: 'Understanding HIPAA requirements and how MediTrack+ ensures compliance.',
      readTime: '10 min read',
      difficulty: 'Intermediate'
    },
    {
      title: 'Data Encryption Standards',
      desc: 'How patient data is encrypted both at rest and in transit.',
      readTime: '8 min read',
      difficulty: 'Intermediate'
    },
    {
      title: 'Access Control & Permissions',
      desc: 'Setting up role-based access controls for different user types.',
      readTime: '9 min read',
      difficulty: 'Advanced'
    },
    {
      title: 'Audit Trail Management',
      desc: 'Tracking and reviewing all system access and data modifications.',
      readTime: '7 min read',
      difficulty: 'Intermediate'
    },
    {
      title: 'Two-Factor Authentication',
      desc: 'Enabling 2FA for enhanced account security across all users.',
      readTime: '5 min read',
      difficulty: 'Beginner'
    },
    {
      title: 'Data Backup & Recovery',
      desc: 'Automated backup procedures and disaster recovery protocols.',
      readTime: '8 min read',
      difficulty: 'Intermediate'
    },
    {
      title: 'Incident Response Planning',
      desc: 'Procedures for handling security incidents and data breaches.',
      readTime: '12 min read',
      difficulty: 'Advanced'
    },
    {
      title: 'Compliance Reporting',
      desc: 'Generating reports for HIPAA audits and regulatory requirements.',
      readTime: '9 min read',
      difficulty: 'Advanced'
    },
    {
      title: 'Patient Data Privacy Settings',
      desc: 'Configuring privacy settings and patient consent management.',
      readTime: '6 min read',
      difficulty: 'Intermediate'
    },
    {
      title: 'Secure Communication Protocols',
      desc: 'Encrypted messaging and secure file transfer capabilities.',
      readTime: '7 min read',
      difficulty: 'Intermediate'
    },
    {
      title: 'Regular Security Assessments',
      desc: 'Scheduled security audits and vulnerability testing procedures.',
      readTime: '11 min read',
      difficulty: 'Advanced'
    },
    {
      title: 'Staff Training Requirements',
      desc: 'Mandatory security training and compliance education for team members.',
      readTime: '6 min read',
      difficulty: 'Beginner'
    },
    {
      title: 'Third-Party Integrations Security',
      desc: 'Security considerations when connecting external systems and APIs.',
      readTime: '10 min read',
      difficulty: 'Advanced'
    },
    {
      title: 'Data Retention Policies',
      desc: 'Managing data lifecycle and secure deletion procedures.',
      readTime: '8 min read',
      difficulty: 'Intermediate'
    }
  ]
      ...
      <section className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
        <div className="text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-extrabold leading-tight mb-6">
            Healthcare <span className="block bg-gradient-to-r from-orange-600 to-orange-700 bg-clip-text text-transparent">
              Security First
            </span>
          </h1>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
            HIPAA compliance, data security, and privacy best practices. Your patients' data is protected with enterprise-grade security.
          </p>
      ...
      <section className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            Security <span className="bg-gradient-to-r from-orange-600 to-orange-700 bg-clip-text text-transparent">Essentials</span>
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Comprehensive guides for HIPAA compliance and healthcare data security.
          </p>
        </div>
