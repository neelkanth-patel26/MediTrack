      ...
      <section className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-40">
        <div className="text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
            Comprehensive technical documentation for integrating with MediTrack+ APIs, implementing custom workflows, and extending platform capabilities.
          </p>
      ...
      <section className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            Documentation <span className="bg-gradient-to-r from-orange-600 to-orange-700 bg-clip-text text-transparent">Categories</span>
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Explore our comprehensive documentation organized by topic and use case.
          </p>
        </div>
          ...
          {[
            {
              icon: Code2,
              title: 'API Reference',
              desc: 'Complete API documentation with endpoints, parameters, and examples for all MediTrack+ services.',
              docs: '25+ endpoints',
            ...
            },
            {
              icon: DatabaseIcon,
              title: 'Data Models',
              desc: 'Detailed schemas for patient records, appointments, prescriptions, and healthcare data structures.',
              docs: '12 data models',
            ...
            },
            {
              ...
              desc: 'OAuth 2.0, API keys, and secure authentication methods for healthcare applications.',
              docs: '8 auth methods',
            ...
            },
            {
              icon: Webhook,
              title: 'Webhooks',
              desc: 'Real-time event notifications and webhook integration for automated workflows.',
              docs: '15+ events',
            ...
            },
            {
              ...
              desc: 'Official SDKs for JavaScript, Python, Java, and .NET with code examples and guides.',
              docs: '4 SDKs',
            ...
            },
            {
              ...
              desc: 'HIPAA compliance, data encryption, audit trails, and security best practices.',
              docs: '18 security guides',
            ...
            return (
              <div key={i} className={`${isDarkMode ? 'bg-card/60 border border-border/50' : 'bg-card/80 border border-border/50'} backdrop-blur-sm rounded-2xl p-6 hover:border-orange-500/30 transition-all duration-300 cursor-pointer group`}>
                ...
                <h3 className="text-xl font-bold mb-3 group-hover:text-orange-400 transition-colors">{category.title}</h3>
                <p className="text-muted-foreground mb-4">{category.desc}</p>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-orange-400 font-medium">{category.docs}</span>
      ...
      <section className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className={`${isDarkMode ? 'bg-gradient-to-r from-orange-500/10 via-orange-500/5 to-orange-500/10' : 'bg-gradient-to-r from-orange-500/10 via-orange-500/5 to-orange-500/10'} rounded-3xl p-12`}>
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              Quick Start <span className="bg-gradient-to-r from-orange-600 to-orange-700 bg-clip-text text-transparent">Guide</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Get up and running with MediTrack+ in minutes with our step-by-step integration guide.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: 'Sign up for a developer account and get your API credentials.'
              },
              {
                step: '02',
                title: 'Choose SDK',
                desc: 'Select your preferred programming language and download the SDK.'
              },
              {
                step: '03',
                title: 'First API Call',
                desc: 'Make your first authenticated API call to retrieve patient data.'
              },
              {
                step: '04',
                title: 'Go Live',
                desc: 'Deploy your integration and start processing healthcare data.'
              }
            ].map((step, i) => (
