...
export default function GettingStartedPage() {
  ...
  const articles = [
    {
      title: 'Creating Your MediTrack+ Account',
      desc: 'Step-by-step guide to registering and verifying your healthcare professional account.',
      readTime: '5 min read',
      difficulty: 'Beginner'
    },
    {
      title: 'Account Verification Process',
      desc: 'Complete your account verification with medical credentials and practice information.',
      readTime: '3 min read',
      difficulty: 'Beginner'
    },
    {
      title: 'Setting Up Your Profile',
      desc: 'Customize your profile with practice details, specialties, and contact information.',
      readTime: '4 min read',
      difficulty: 'Beginner'
    },
    {
      title: 'Navigating the Dashboard',
      desc: 'Overview of the main dashboard and key navigation elements.',
      readTime: '6 min read',
      difficulty: 'Beginner'
    },
    {
      title: 'Understanding User Roles & Permissions',
      desc: 'Learn about different user roles and access levels in your practice.',
      readTime: '7 min read',
      difficulty: 'Intermediate'
    },
    {
      title: 'Connecting Your Practice Management System',
      desc: 'Integrate MediTrack+ with your existing practice management software.',
      readTime: '10 min read',
      difficulty: 'Intermediate'
    },
    {
      title: 'Setting Up Multi-Location Practices',
      desc: 'Configure MediTrack+ for practices with multiple locations.',
      readTime: '8 min read',
      difficulty: 'Advanced'
    },
    {
      title: 'Team Member Invitations',
      desc: 'Invite and manage team members with appropriate access levels.',
      readTime: '5 min read',
      difficulty: 'Beginner'
    },
    {
      title: 'Initial Data Import',
      desc: 'Import existing patient data and medical records securely.',
      readTime: '12 min read',
      difficulty: 'Advanced'
    },
    {
      title: 'Customizing Practice Settings',
      desc: 'Configure appointment types, insurance settings, and practice preferences.',
      readTime: '9 min read',
      difficulty: 'Intermediate'
    },
    {
      title: 'Setting Up Automated Workflows',
      desc: 'Create automated workflows for patient intake and follow-up processes.',
      readTime: '11 min read',
      difficulty: 'Advanced'
    },
    {
      title: 'Security Best Practices Setup',
      desc: 'Configure two-factor authentication and security settings.',
      readTime: '6 min read',
      difficulty: 'Beginner'
    }
  ]
      ...
      <section className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
        <div className="text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-extrabold leading-tight mb-6">
            Welcome to <span className="block bg-gradient-to-r from-orange-600 to-orange-700 bg-clip-text text-transparent">
              MediTrack+
            </span>
          </h1>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
            Learn the basics of MediTrack+ and set up your account for the first time. Follow our step-by-step guides to get your practice up and running quickly.
          </p>
      ...
      <section className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            Setup <span className="bg-gradient-to-r from-orange-600 to-orange-700 bg-clip-text text-transparent">Articles</span>
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Complete guides to help you set up and configure MediTrack+ for your practice.
          </p>
        </div>
      ...
      <section className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className={`${isDarkMode ? 'bg-gradient-to-r from-orange-500/10 via-orange-500/5 to-orange-500/10' : 'bg-gradient-to-r from-orange-500/10 via-orange-500/5 to-orange-500/10'} rounded-3xl p-12`}>
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              Quick Start <span className="bg-gradient-to-r from-orange-600 to-orange-700 bg-clip-text text-transparent">Checklist</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Follow these essential steps to get MediTrack+ up and running in your practice.
            </p>
          </div>

          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {[
              { step: 1, title: 'Create Account', desc: 'Register and verify your healthcare professional account' },
              { step: 2, title: 'Set Up Profile', desc: 'Add practice details, specialties, and team information' },
              { step: 3, title: 'Configure Settings', desc: 'Set up appointment types, insurance, and preferences' },
              { step: 4, title: 'Import Data', desc: 'Bring in existing patient records and practice data' },
              { step: 5, title: 'Invite Team', desc: 'Add team members with appropriate access levels' },
              { step: 6, title: 'Go Live', desc: 'Start using MediTrack+ with your first patients' }
            ].map((item, i) => (
