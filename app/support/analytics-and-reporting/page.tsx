  ...
  const articles = [
    {
      ...
      desc: 'Build personalized reports tailored to your practice needs and KPIs.',
      readTime: '9 min read',
      difficulty: 'Intermediate'
    },
    {
      title: 'Patient Volume Analytics',
      desc: 'Analyze patient visit patterns and practice utilization metrics.',
      readTime: '7 min read',
      difficulty: 'Intermediate'
    },
    {
      title: 'Financial Performance Reports',
      desc: 'Track revenue, expenses, and profitability across your practice.',
      readTime: '10 min read',
      difficulty: 'Advanced'
    },
    {
      title: 'Clinical Outcome Metrics',
      desc: 'Monitor treatment success rates and patient health improvements.',
      readTime: '8 min read',
      difficulty: 'Advanced'
    },
    {
      title: 'Appointment Scheduling Analytics',
      desc: 'Analyze booking patterns, no-show rates, and scheduling efficiency.',
      readTime: '6 min read',
      difficulty: 'Intermediate'
    },
    {
      title: 'Staff Performance Dashboard',
      desc: 'Track provider productivity, patient satisfaction, and workload distribution.',
      readTime: '8 min read',
      difficulty: 'Intermediate'
    },
    {
      title: 'Automated Report Scheduling',
      desc: 'Set up recurring reports to be delivered automatically via email.',
      readTime: '5 min read',
      difficulty: 'Beginner'
    },
    {
      title: 'Data Export & Integration',
      desc: 'Export analytics data for use in external business intelligence tools.',
      readTime: '7 min read',
      difficulty: 'Advanced'
    }
  ]
      ...
      <section className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
        <div className="text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
            Generate reports, analyze data, and track practice performance. Make informed decisions with comprehensive healthcare analytics.
          </p>
      ...
      <section className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            Analytics <span className="bg-gradient-to-r from-orange-600 to-orange-700 bg-clip-text text-transparent">Tools</span>
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Comprehensive guides for generating insights and optimizing practice performance.
          </p>
        </div>
